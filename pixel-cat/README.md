...
- **Cat color** — right-click Cat color… to tune Mira with RGB sliders from 0-255; the color applies to idle, yapping, and typing sprites and persists.
...
- **Mood check-ins** — on weekdays at 09:30, Mira asks how you're feeling and adapts the next morning's prompt to the previous workday. At 17:00 on Friday, she opens a visual recap with emoji mood trail, conquered checklist/reminder activity, and encouragement based on the week.
